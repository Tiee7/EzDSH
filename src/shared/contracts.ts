...
export interface EzDSHBridge {
  ...
  workbench: {
    ...
    migration: {
      ...
      applyBatch(request: import('./workbench-migration.js').WorkbenchMigrationBatchApplyRequest): Promise<import('./workbench-migration.js').WorkbenchMigrationBatchApplyResult>
