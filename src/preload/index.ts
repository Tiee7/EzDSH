...
const bridge: EzDSHBridge = {
  ...
  workItems: {
    ...
    previewDelete: (request) => invoke('work-items:preview-delete', request),
    purgeDelete: (request) => invoke('work-items:purge-delete', request),
  ...
  workbench: {
    ...
    migration: {
      ...
      applyBatch: (request: WorkbenchMigrationBatchApplyRequest) => invoke<WorkbenchMigrationBatchApplyResult>('workbench-migration:apply-batch', request),
