...
Task 4: complete (commit c491ec0; append-only redacted observations, deployment recording, and health summary)
Task 5: pending (Main, IPC, and Workflow UI)
Task 6: pending (documentation and verification)
